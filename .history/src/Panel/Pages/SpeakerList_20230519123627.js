      ...
      <div className="mainTable">
        ...
        <Table className="ColorTable">
          ...
          <tbody>
            <tr>
              <td>
                <span style={{display : 'flex' , gap : '10px' , alignItems}}>
                  <img src='https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8dXNlciUyMHByb2ZpbGV8ZW58MHx8MHx8fDA%3D&w=1000&q=80' alt='ProfileImage' style={{width : '60px' , height : '60px' , borderRadius : '100%'}}  />
                  Alen Maria
                </span>
              </td>
              <td>
