    ...
    const postHandler = async () => {
      try {
        Store.addNotification({
          title: "Created",
          message: "New Speaker Created Event ",
          type: "success",
          insert: "top",
          container: "top-right",
        ...
        <Modal.Body>
          <Form>
            ...
            <Form.Group className="mb-3">
              ...
              <Form.Control type="tel" pattern="[0-9]{10}" placeholder="Enter Your Mobile Number" />
            </Form.Group>
            <Form.Group className="mb-3">
              <Form.Label>BIO</Form.Label>
              <FloatingLabel controlId="floatingTextarea2" label="Enter Your BIO Here">
        <Form.Control
          as="textarea"
